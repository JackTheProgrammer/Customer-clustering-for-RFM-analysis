...
For RFM analysis of ecommerce; recency should be done in hours, because most of the time the purchase may occur on a similar day, but on different time. I did followed the mentioned tutorial approach, got 0 in more than 70--80 rows as recency, the reason  was that a lot of purchases happened at the maximum date, but on different hours, then I shifted my approach to hours.
